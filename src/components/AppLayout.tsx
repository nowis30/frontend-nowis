...
const links = [
  ...
  { to: '/corporate/dividends', label: 'Dividendes' },
  { to: '/corporate/roc', label: 'Retour de capital' },
  { to: '/tax/exports', label: 'Exports fiscaux' },
  ...
  { to: '/personal-income', label: 'Revenus personnels' },
